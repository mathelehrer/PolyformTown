...
static const char *base_for_state(int s){return s=='0'?BASE_D0:s=='1'?BASE_D1:(s=='B'||s=='G'?BASE_H:NULL);}
...
static const char*fill(char state,int tree){if(tree)return state=='0'?"#f1d777":state=='1'?"#f5af74":state=='B'?"#c49a76":"#79c996";return state=='0'?"#7da9f7":state=='1'?"#ef8d8d":"#79c996";}
