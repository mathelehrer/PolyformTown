#!/usr/bin/env python3
"""Generate RL7 rephex ordinary-hat print conversion data from RL5/RL6.
...
def main(argv: List[str]) -> int:
    ...
    output = (Path(argv[2]) if len(argv) > 2
              else root / "data/rl7/hat/print_conversion.dat")
    ...
    lines = [
        ...
        "# GENERATED DATA: do not edit; regenerate with `make boot_rl7`.",
